...
class Expenses_model extends CI_Model {
	...
	public function get_coverage_code() {
		return array(
      'V11E' => 'Accessibility Corrective Device (V11E)',
      'V17AD' => 'Accidental Death and Dismemberment (V17AD)',
      'V12' => 'Air Flight Accident (V12)',
      'V04A' => 'Ambulance (V04A)',
      'V10B' => 'Contraceptive/Morning after pill (V10B)',
      'V08B' => 'Death - Cremation/Burial (V08B)',
      'V08A' => 'Death - Return of Remains (V08A)',
      'V06' => 'Dental - Accidental Dental (V06)',
      'V06C' => 'Dental - Impacted Wisdom Teeth (V06C)',
      'V06B' => 'Dental - Relief of Dental Pain (V06B)',
      'V02BY' => 'Diagnostic - Biopsy (V02BY)',
      'V02BB' => 'Diagnostic - Blood Test (V02BB)',
      'V02BH' => 'Diagnostic - Colonoscopy (V02BH)',
      'V02BC' => 'Diagnostic - CT Scans (V02BC)',
      'V02BE' => 'Diagnostic - Echocardiogram (V02BE)',
      'V02BG' => 'Diagnostic - Gastroscopy/Endoscopy (V02BG)',
      'V02BF' => 'Diagnostic - Mammogram (V02BF)',
      'V02BM' => 'Diagnostic - MRI (V02BM)',
      'V02BT' => 'Diagnostic - Ultrasound (V02BT)',
      'V02BU' => 'Diagnostic - Urine Test (V02BU)',
      'V02BX' => 'Diagnostic - X-Ray (V02BX)',
      'V02B' => 'Diagnostic Services (V02B)',
      'V11B' => 'Eye Examination (V11B)',
      'V11C' => 'Eyeglasses/Contact Lenses (V11C)',
      ...
      'O' => 'Miscellaneous (O)',
      'V02BO' => 'Other Diagnostic (V02BO)',
      'V02AO' => 'Other Emergency  (V02AO)',
      'V02AS' => 'Outpatient - Specialist Visit (V02AS)',
      'V01A' => 'Outpatient Treatment (V01A)',
      'V02D' => 'Paramedical - Acupuncture (V02D)',
      'V02H' => 'Paramedical - Chiropodist (V02H)',
      'V02G' => 'Paramedical - Chiropractor (V02G)',
      'VO2K' => 'Paramedical - Optometrist (VO2K)',
      'V02E' => 'Paramedical - Osteopath (V02E)',
      'V02F' => 'Paramedical - Physiotherapy (V02F)',
      'V02J' => 'Paramedical - Podiatrist (V02J)',
      'V02A' => 'Paramedical Services (V02A)',
      'V11A' => 'Physical Examination (V11A)',
      'V07' => 'Prescription Drugs (V07)',
      'V13' => 'Private Duty Nursing (V13)',
      'V16B' => 'Psychiatric Hospitalization (V16B)',
      'V16A' => 'Psychiatric/Psychological Therapy (V16A)',
      'V18' => 'Repatriation (V18)',
      'V0JFA' => 'TO - Air Ticket (V0JFA)',
      'V0JF9' => 'TO - Baggage Damage (V0JF9)',
      'V0JF8' => 'TO - Baggage Loss (V0JF8)',
      'VOJFE' => 'TO - Excess Baggage Return (VOJFE)',
      'V0JF4' => 'TO - Hotel (V0JF4)',
      'V0JF6' => 'TO - Internet (V0JF6)',
      'V0JF3' => 'TO - Meal (V0JF3)',
      'VOJFD' => 'TO - Pet Return (VOJFD)',
      'V0JF7' => 'TO - Phone (V0JF7)',
      'V0JFB' => 'TO - Prescription replacement (V0JFB)',
      'VOJFC' => 'TO - Return of Travel Companion (VOJFC)',
      'VOJFF' => 'TO - Return to Original Trip Destination (VOJFF)',
      'V0JF5' => 'TO - Transportation (V0JF5)',
      'V0JF2' => 'TO - Trip Cancelation (V0JF2)',
      'V0JF1' => 'TO - Trip Interruption (V0JF1)',
      'V09C' => 'Transport to Bedside Accommodation (V09C)',
      'V09A' => 'Transportation to Bedside (V09A)',
      'V17AT' => 'Trauma Counseling (V17AT)',
      'V14' => 'Tuberculosis Testing and Vaccination (V14)',
      'V15' => 'Tutorial Services (V15)',
      'V09B' => 'Vehicle Return (V09B)',

      'F-V11E'  => "Dispositif correcteur d'accessibilité (V11E)",
      'F-V17AD' => "Décès et mutilation accidentels (V17AD)",
      'F-V12'   => "Accident de vol aérien (V12)",
      'F-V04A'  => "Ambulance (V04A)",
      'F-V10B'  => "Contraceptif/pilule du lendemain (V10B)",
      'F-V08B'  => "Décès - Crémation/Inhumation (V08B)",
      'F-V08A'  => "Décès - Retour de la dépouille (V08A)",
      'F-V06'   => "Dentaire - Accident Dentaire (V06)",
      'F-V06C'  => "Dentaire - Dents de sagesse incluses (V06C)",
      'F-V06B'  => "Dentaire - Soulagement de la douleur dentaire (V06B)",
      'F-V02BY' => "Diagnostic - Biopsie (V02BY)",
      'F-V02BB' => "Diagnostic - Test sanguin (V02BB)",
      'F-V02BH' => "Diagnostic - Coloscopie (V02BH)",
      'F-V02BC' => "Diagnostic - CT Scans (V02BC)",
      'F-V02BE' => "Diagnostic - Échocardiogramme (V02BE)",
      'F-V02BG' => "Diagnostic - Gastroscopie/Endoscopie (V02BG)",
      'F-V02BF' => "Diagnostic - Mammographie (V02BF)",
      'F-V02BM' => "Diagnostic - IRM (V02BM)",
      'F-V02BT' => "Diagnostic - Échographie (V02BT)",
      'F-V02BU' => "Diagnostic - Test d'urine (V02BU)",
      'F-V02BX' => "Diagnostic - Rayons X (V02BX)",
      'F-V02B'  => "Services de diagnostic (V02B)",
      'F-V11B'  => "Examen de la vue (V11B)",
      'F-V11C'  => "Lunettes/lentilles de contact (V11C)",
      'F-V11D'  => "Prothèses auditives (V11D)",
      'F-V02AE' => "Hôpital - Visite à l'urgence (V02AE)",
      'F-V01'   => "Hôpital - Hospitalisation (V01)",
      'F-V02'   => "Hôpital - Traitement par un médecin (V02)",
      'F-V10A'  => "Maternité (V10A)",
      'F-V01B'  => "Appareils médicaux (V01B)",
      'F-V02M'  => "Dossiers médicaux (V02M)",
      'F-O'     => "Divers (O)",
      'F-V02BO' => "Autre diagnostic (V02BO)",
      'F-V02AO' => "Autre urgence (V02AO)",
      'F-V02AS' => "Ambulatoire - Visite chez le spécialiste (V02AS)",
      'F-V01A'  => "Traitement ambulatoire (V01A)",
      'F-V02D'  => "Paramédical - Acupuncture (V02D)",
      'F-V02H'  => "Paramédical - Podologue (V02H)",
      'F-V02G'  => "Paramédical - Chiropraticien (V02G)",
      'F-VO2K'  => "Paramédical - Optométriste (VO2K)",
      'F-V02E'  => "Paramédical - Ostéopathe (V02E)",
      'F-V02F'  => "Paramédical - Physiothérapie (V02F)",
      'F-V02J'  => "Paramédical - Podiatre (V02J)",
      'F-V02A'  => "Services paramédicaux (V02A)",
      'F-V11A'  => "Examen physique (V11A)",
      'F-V07'   => "Médicaments sur ordonnance (V07)",
      'F-V13'   => "Soins infirmiers privés (V13)",
      'F-V16B'  => "Hospitalisation psychiatrique (V16B)",
      'F-V16A'  => "Thérapie psychiatrique/psychologique (V16A)",
      'F-V18'   => "Rapatriement (V18)",
      'F-V0JFA' => "TO - Billet d'avion (V0JFA)",
      'F-V0JF9' => "TO - Dommages aux bagages (V0JF9)",
      'F-V0JF8' => "TO - Perte de bagages (V0JF8)",
      'F-VOJFE' => "TO - Retour d'excédent de bagages (VOJFE)",
      'F-V0JF4' => "TO - Hôtel (V0JF4)",
      'F-V0JF6' => "TO - Internet (V0JF6)",
      'F-V0JF3' => "TO - Repas (V0JF3)",
      'F-VOJFD' => "TO - Retour d'animaux (VOJFD)",
      'F-V0JF7' => "TO - Téléphone (V0JF7)",
      'F-V0JFB' => "TO - Remplacement d'ordonnance (V0JFB)",
      'F-VOJFC' => "TO - Compagnon de voyage de retour (VOJFC)",
      'F-VOJFF' => "TO - Retour à la destination de voyage initiale (VOJFF)",
      'F-V0JF5' => "TO - Transport (V0JF5)",
      'F-V0JF2' => "TO - Annulation de voyage (V0JF2)",
      'F-V0JF1' => "TO - Interruption de voyage (V0JF1)",
      'F-V09C'  => "Transport au chevet du patient (V09C)",
      'F-V09A'  => "Transport au chevet du patient (V09A)",
      'F-V17AT' => "Conseil en traumatologie (V17AT)",
      'F-V14'   => "Dépistage de la tuberculose et vaccination (V14)",
      'F-V15'   => "Services d'aide à l'apprentissage (V15)",
      'F-V09B'  => "Retour du véhicule (V09B)",
    );
	}
	...
	public function get_report($data, $nozero='', $monthly=TRUE) {
		...
		$sql  = "SELECT e.claim_no, e.invoice, e.provider_name, c.sum_insured, c.diagnosis, c.insured_first_name as first_name, c.insured_last_name as last_name, c.dob as birth_day, c.gender, c.policy_no, e.date_of_service, c.totaldays, e.finalize_date, IF(e.status='".self::EXPENSE_STATUS_Paid."','F',( IF(e.status='".self::EXPENSE_STATUS_Declined."' OR e.status='".self::EXPENSE_STATUS_Duplicated."', 'D', 'P') )) as status, c.status2, IF(e.reason='Other',e.reason_other,e.reason) AS reason, e.created, e.amount_claimed, e.amt_payable, 0 as reserve_amount, e.recovery_amt, c.street_address, c.city, c.province, c.post_code, c.agent_id, c.assign_to, e.service_description, e.coverage_code, e.amt_deductible, e.pay_to, p.up_insuer  FROM expenses_claimed e";

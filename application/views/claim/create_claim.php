		...
		<div class="row" style="border: 1px solid rgb(204, 204, 204); padding: 10px; margin-bottom: 9px">
			<div class="col-sm-3">
				...
				<select name="payees[payment_type][]" class="form-control payees_payment_type">
					<option value="cheque" selected>Email Transfer </option>
					<option value="email">Deposit</option>
				</select>
...
<?php } ?>
   ...
   $(document).ready(function() {
      ...
      if ((product_short != '') && (product_short != 'REF') && (product_short != 'OPL') && (product_short != 'JFR') && (product_short != 'JFS') && (product_short != 'JFE') && (product_short != 'JES') && (product_short != 'JESP') && (product_short != 'JFC') && (product_short != 'JFP')) {
      ...
      $.ajax({
         ...
         success: function(data){
            if(typeof data.plan_list != "undefined" && data.plan_list.length) {
                ...
                if ((data.plan_list[0].product_short != 'REF') && (data.plan_list[0].product_short != 'OPL') && (data.plan_list[0].product_short != 'JFR') && (data.plan_list[0].product_short != 'JFS') && (data.plan_list[0].product_short != 'JFE') && (data.plan_list[0].product_short != 'JES') && (data.plan_list[0].product_short != 'JESP') && (data.plan_list[0].product_short != 'JFC') && (data.plan_list[0].product_short != 'JFP')) {
	...
	<?php if ($this->input->get('policy')) { ?>
      $.ajax({
         ...
         success: function(data){
            ...
            {
               localStorage.setItem("policy_data", JSON.stringify(data.plan_list));
               if ((data.plan_list[0].product_short != 'REF') && (data.plan_list[0].product_short != 'OPL') && (data.plan_list[0].product_short != 'JFR') && (data.plan_list[0].product_short != 'JES') && (data.plan_list[0].product_short != 'JESP') && (data.plan_list[0].product_short != 'JFC') && (data.plan_list[0].product_short != 'JFP')) {
               	window.location.href = "<?php echo base_url() ?>" + "/claim/create_other?policy=" + $("input[name=policy_no]").val() + "&case_no=" + $("input[name=case_no]").val() + "&product_short=" + $("input[name=product_short]").val() + "&firstname=" + $("input[name=insured_first_name]").val() + "&lastname=" + $("input[name=insured_last_name]").val() + "&birthday=" + $("input[name=dob]").val() + "&gender=" + $("input[name=gender]").val();
               }
               $("input[name=policy_info]").val(JSON.stringify(data.plan_list));
               if (data.plan_list[0].status_id == 5) {

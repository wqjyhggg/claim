				...
				<div class="x_content">
					...
					<div class="row" style="margin-bottom: 15px; display: none">
						...
						<div class="form-group col-sm-3">
							...
							<input type='hidden' name='package' value='<?php echo ($this->input->post("package") ? $this->input->post("package") : $this->input->get("package")); ?>'>
						</div>
						<div class="form-group col-sm-3">
								...
								<div class="row" style="border: 1px solid rgb(204, 204, 204); padding: 10px;">
									...
									<div class="col-sm-3">
										...
										<?php } else { ?>
											...
											<option value="<?php echo $payee['id']; ?>" <?php echo (($payee['id'] == $arr['payee'][$key]) ? "Selected" : ""); ?>><?php echo htmlspecialchars($payee['payment_type'] . " : " . $payee['payee_name'] . " : " . $payee['address'] . " " . $val['city'] . ", " . $payee['province'] . " " . $payee['country'] . " " . $payee['postcode']); ?></option>
											<?php } else { ?> 
      ...
      $.ajax({
         ...
         success: function(data){
            if(typeof data.plan_list != "undefined" && data.plan_list.length)
            {
               ...
               $("input[name=package]").val(data.plan_list[0].package);

   ...
   <body>
    <table>
      ...
      <tr>
        ...
        <td><?php echo $claim["dob"] . "/" . (intval(substr($policy["apply_date"], 0, 4)) - intval(substr($claim["dob"], 0, 4))) . "/" . ucfirst($claim["gendar"]); ?></td>
      </tr>
      <tr>
        <td>Claim Number</td>
      ...
      <tr>
        ...
        <td><?php echo $claim["city"] . " " . $claim["province2"]; ?></td>
      </tr>
      <tr>
        <td>Date of Loss</td>

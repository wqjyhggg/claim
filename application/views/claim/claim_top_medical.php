					...
					<div class="case_info">
						...
						<div class="row" style="display: none">
							...
							<div class="form-group col-sm-6">
								...
								<?php echo form_input("exinfo[group_insurance_company]", isset($exinfo["group_insurance_companty"]) ? $exinfo["group_insurance_company"] :'', array("class" => "form-control", 'placeholder' => 'Name and Address of Insurance Company')); ?>
							</div>
							<div class="form-group col-sm-3">

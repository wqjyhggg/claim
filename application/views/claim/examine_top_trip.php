					...
					<?php if (empty($items)) { echo "There is no item for this claim"; } else { ?>
						<div class="table-responsive claim_items">
							<table class="table table-hover table-bordered" style='overflow: hidden; margin-right: 26px; padding-right: 26px;'>
								...
								?>
									<tr class="row-link claim_items" data-id="<?php echo $value['id']; ?>" item_provider_name="<?php echo $value['item_provider_name']; ?>" item_provider_addr1="<?php echo $value['item_provider_addr1']; ?>" item_provider_addr2="<?php echo $value['item_provider_addr2']; ?>" item_provider_postcode="<?php echo $value['item_provider_postcode']; ?>"

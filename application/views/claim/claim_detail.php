		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
							...
							<div class="col-sm-12" style="margin-top: 20px">
								...
								<div class="form-group col-sm-12">
									<div class="col-sm-3">
										...
										<div class="input-group date">
											<?php echo form_input("medication_date_1", $claim_details["medication_date_1"], array("class" => "form-control datepicker", 'placeholder' => 'Date')); ?>
											<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
									<div class="col-sm-3">
								...
								<div class="form-group col-sm-12">
									<div class="col-sm-3">
										...
										<div class="input-group date">
											<?php echo form_input("medication_date_2", $claim_details["medication_date_2"], array("class" => "form-control datepicker", 'placeholder' => 'Date')); ?>
											<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
									<div class="col-sm-3">
								...
								<div class="form-group col-sm-12">
									<div class="col-sm-3">
										...
										<div class="input-group date">
											<?php echo form_input("medication_date_3", $claim_details["medication_date_3"], array("class" => "form-control datepicker", 'placeholder' => 'Date')); ?>
											<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
									<div class="col-sm-3">
								...
								<div class="payee-data">
									...
									<div class="row" style="border: 1px solid rgb(204, 204, 204); padding: 10px; margin-bottom: 9px">
										...
										<div class="col-sm-3 wire_transfer_section" <?php echo ($value["payment_type"] == 'cheque'?'style="display:none"':''); ?>>
											...
											<?php echo form_input("payees[bank][]", $value ["bank"], array("class" => "form-control", 'placeholder' => 'Email Address', "readonly" => "readonly")); ?>
										</div>
              ...
              <div class="col-sm-3 searchInputDiv" >
								...
								<div class="expenses-list">
									...
									<div class="row" style="border: 1px solid rgb(204, 204, 204); padding: 10px;">
										...
										<div class="col-sm-3">
											...
											<?php echo htmlspecialchars($value['date_of_service']); ?>
										...
										<div class="col-sm-3">
											...
											<?php echo htmlspecialchars($value['amount_billed_org']); ?>
										...
										<div class="col-sm-3">
											...
											<?php echo htmlspecialchars($value["other_reimbursed_amount"]); ?>
										...
										<div class="col-sm-3">
											...
											<?php echo htmlspecialchars($value['amount_client_paid_org']); ?>
										...
										<div class="col-sm-3">
											...
											<?php echo htmlspecialchars($value["amount_claimed_org"]); ?>
										...
										<div class="col-sm-3">
											...
											<?php echo htmlspecialchars($value ['currency']); ?>
									...
									<div class="row" style="border: 1px solid rgb(204, 204, 204); padding: 10px;">
										...
										<div class="col-sm-3">
											...
											<?php if (1 == $value ["provider_type"]) { ?>
												...
												<option value="<?php echo $val['id']; ?>" <?php if ($val['id'] == $value ["expenses_provider_id"]) { echo "selected"; } ?>><?php echo $val['name'] . " : " . $val['address'] . " " . $val['city'] . ", " . $val['province'] . " " . $val['country'] . " " . $val['postcode']; ?></option>
												<?php endforeach; ?>
											<?php } else { ?>
                      ...
                      <?php if (empty($value["expenses_provider_id"])) { echo "Name: " . htmlspecialchars($value['provider_name']); } ?>
											<?php echo form_hidden("expenses_claimed[provider_name][]", $value['provider_name']); ?>
										</div>
										<div class="col-sm-3">
											<?php echo form_label('Name of Referring Physician:', 'referencing_physician', array("class" => 'col-sm-12')); ?>
										...
										<div class="col-sm-3">
											...
											<select name="expenses_claimed[coverage_code][]" class="form-control required">
												...
												<?php foreach ($expenses_list as $ekey => $val): ?>
												<option value="<?php echo $ekey; ?>" <?php if ($ekey == $value ["coverage_code"]) { echo "selected"; } ?>><?php echo $val; ?></option>
												<?php endforeach; ?>
											</select>
										</div>
										...
										<div class="col-sm-3">
											<?php echo form_label('Amount reimbursed / refunded by other party:', 'amount_claimed', array("class" => 'col-sm-12')); ?>
						...
						<div class="row intake-forms-list col-sm-12" style="display: none">
							...
							<div class="col-sm-12 intake-forms">
								<div class="col-sm-2">
									...
									<div class="col-sm-12"><?php echo htmlspecialchars($value['created_by']); ?></div>
							...
							<div class="col-sm-12">
								<div class="col-sm-12 uploaded_files">
									...
									<div class="col-sm-9">
										...
										<?php echo anchor((substr($file,0,4)=="http")?$file:"claim_doc_download/" . $file . '__' . $claim_details['id'], '<i class="fa fa-download row-link"></i>', array('title'=>'Download File')); ?>
...
<?php } ?>
   ...
   .on("click", ".remove_claim", function(){
    ...
    if (!name) {
		...
		$.ajax({
			...
			method:"post",
			data:{claim_id:'<?php echo $claim_details["id"]; ?>',name:name,address:address,city:city,province:province,country:country,postcode:postcode},
			dataType:"json",
			success: function(data) {
				if (data.success) {
					myid.val(data.id);
	...
	.on("click", ".payee_policy_addr", function() {
		...
		if (data[0].suite_number) {
			addr.val("Suite "+data[0].suite_number+" - "+data[0].street_number+" "+data[0].street_name);
		} else {
   ...
   .on("click", "#mail_address", function(){
      if($(this).is(":checked"))
      {
         ...
         $("input[name=email]").val("<?php echo @htmlspecialchars($policy_info[0]['contact_email']); ?>");
         $("input[name=street_no_email]").val("<?php echo @htmlspecialchars($policy_info[0]['street_number']); ?>");
         $("input[name=street_name_email]").val("<?php echo @htmlspecialchars($policy_info[0]['street_name']); ?>");
         $("input[name=city_email]").val("<?php echo @htmlspecialchars($policy_info[0]['city']); ?>");
         $("select[name=province_email]").val("<?php echo @htmlspecialchars($policy_info[0]['province2']); ?>");
      }
      else
      {

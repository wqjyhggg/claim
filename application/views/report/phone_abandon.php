						...
						<table class="table table-hover table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo empty($value['calls']) ? 0 : number_format($value['less10'] * 100 / $value['calls'], 2); ?>%</td>
									<td><?php echo empty($value['calls']) ? 0 : number_format($value['less20'] * 100 / $value['calls'], 2); ?>%</td>
									<td><?php echo empty($value['calls']) ? 0 : number_format($value['less30'] * 100 / $value['calls'], 2); ?>%</td>
									<td><?php echo empty($value['calls']) ? 0 : number_format($value['less40'] * 100 / $value['calls'], 2); ?>%</td>
									<td><?php echo empty($value['calls']) ? 0 : number_format($value['less50'] * 100 / $value['calls'], 2); ?>%</td>
									<td><?php echo empty($value['calls']) ? 0 : number_format($value['abandons'] * 100 / $value['calls'], 2); ?>%</td>
									<td><?php echo $this->phone_model->second_to_time($value['avg_abandon']); ?></td>
								...
								<tr>
									...
									<td><?php echo empty($t_calls) ? 0 : number_format($t_less10 * 100 / $t_calls, 2); ?>%</td>
									<td><?php echo empty($t_calls) ? 0 : number_format($t_less20 * 100 / $t_calls, 2); ?>%</td>
									<td><?php echo empty($t_calls) ? 0 : number_format($t_less30 * 100 / $t_calls, 2); ?>%</td>
									<td><?php echo empty($t_calls) ? 0 : number_format($t_less40 * 100 / $t_calls, 2); ?>%</td>
									<td><?php echo empty($t_calls) ? 0 : number_format($t_less50 * 100 / $t_calls, 2); ?>%</td>
									<td><?php echo empty($t_calls) ? 0 : number_format($t_abandons * 100 / $t_calls, 2); ?>%</td>
									<td><?php echo empty($t_abandons) ? 0 : $this->phone_model->second_to_time($t_total_abandon/$t_abandons); ?></td>

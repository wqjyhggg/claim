		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="form-group col-sm-3">
								<?php echo form_label('Claim Item Finalized From Date:', 'finalized_start_dt', array("class" => 'col-sm-12'));   ?>
								<div class="input-group date">
									<?php echo form_input("finalized_start_dt", $finalized_start_dt, array("class" => "form-control datepicker required", 'placeholder' => 'From Date')); ?>
							...
							<div class="form-group col-sm-3">
								...
								<div class="input-group date">
									<?php echo form_input("finalized_end_dt", $finalized_end_dt, array("class" => "form-control datepicker required", 'placeholder' => 'To Date')); ?>
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
								</div>
								<?php echo form_error("dob"); ?>
							</div>
            ...
            <table class="table table-hover table-bordered">
              <thead>
                <tr>
                  ...
                  <th>Claim Item Status</th>
                  <th>Claimed Amount for Item</th>
                  <th>Amount Paid for item</th>
                </tr>
              </thead>
              <tbody>
                <?php foreach ($reports as $value) { ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $value['e_status']; ?></td>
                    <td><?php echo number_format($value['amount_claimed'], 2); ?></td>
                    <td><?php echo number_format($value['amt_payable'], 2); ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>

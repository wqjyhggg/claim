		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
              ...
              <div class="col-sm-5">
                ...
                <?php echo form_radio("is_examiner", "0", ($is_examiner != 1), array('class' => 'setpremium')); ?>  By Claim Amount
              </div>
              <div class="col-sm-5">
                <?php echo form_label('&nbsp;', 'is_examiner', array("class" => 'col-sm-12')); ?>
            ...
            <div class="form-group col-sm-3">
              ...
              <select name="product_short" class="form-control">
                <option value="" <?php if (empty($product_short)) { echo "selected"; } ?>> -- Select as Product -- </option>
                <?php foreach ($products as $key => $prod):?>
                <option value="<?php echo $key; ?>" <?php if ($key == $product_short) { echo "selected"; } ?>><?php echo $prod; ?></option>
                <?php endforeach; ?>
              </select>
            </div>
            <div class="form-group col-sm-3">
            ...
            <div class="form-group col-sm-3">
              <div id="examiner_div" style="display: none;">
                ...
                <select name="examiner_id" class="form-control">
                  <option value="0" <?php if (empty($examiner_id)) { echo "selected"; } ?>> -- Select as Examiner -- </option>
                  <?php foreach ($examiners as $val):?>
                  <option value="<?php echo $val['id']; ?>" <?php if ($val['id'] == $examiner_id) { echo "selected"; } ?>><?php echo $val['email']; ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
						...
						<div class="form-group col-sm-3">
              <a class="btn btn-primary" href="<?php echo $export_url; ?>" value="1">Export</a>
						</div>
						<div class="form-group col-sm-3">
							<button class="btn btn-primary" name="submit" value="1">Submit</button>
						</div>
					<?php echo form_close(); ?>
				</div>
			</div>

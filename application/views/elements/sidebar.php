<ul class="nav side-menu" style="">
	...
	<?php if ($this->ion_auth->is_admin() OR $this->ion_auth->is_claimsmanager() OR $this->ion_auth->is_claimexaminer()): ?>
	...
	<?php if ($this->ion_auth->is_admin() OR $this->ion_auth->is_accountant()): ?>

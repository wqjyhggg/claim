<div>
				...
				<div class="x_content">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<?php echo anchor("auth/users", "Reset", array('class'=>'btn btn-info'))?><a href="javascript:void(0)" class="btn btn-info more_filters">Advanced Search</a>
						</div>
					</div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>Users List<small></small></h2><?php echo anchor("auth/edit_user", 'Add', array("class"=>'btn btn-primary pull-right')) ;?>
					<div class="clearfix"></div>
				</div>
				<div class="x_content">
					<?php if(!empty($users)) : ?>
...
<script>
<?php if ($this->input->get ( "status" ) != '' or $this->input->get ( "last_name" ) or $this->input->get ( "first_name" ) or $this->input->get ( "email" )) { ?>
$(".more_items").show();
<?php } ?>

			...
			<div class="x_panel">
					...
					<div class="case_info">
						...
						<div class="row" style="display: none">
							...
							<div class="col-sm-3" style='display: none'>
								...
								<?php echo form_input("personal_id", $eclaim["personal_id"], array("class" => "form-control", 'placeholder' => 'ID')); ?>
              ...
              <div class="form-group col-sm-3">
							...
							<div class="form-group col-sm-3">
								...
								<div class="input-group date">
									<?php echo form_input("exinfo[return_date]", isset($eclaim["exinfo_return_date"]) ? $eclaim["exinfo_return_date"] : '', array("class" => "form-control datepicker", 'placeholder' => 'Date of Return to home province')); ?>
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
								</div>
							</div>
							<div class="form-group col-sm-3">
							...
							<div class="col-sm-12">
								Do you have other travel medical insurance coverage? <input type="checkbox" name="exinfo[other_medical_insurance]" value="1" <?php if (!empty($eclaim["exinfo_other_medical_insurance"])) { echo "checked"; } ?>> Yes. If 'yes', please provide the following information:_
							</div>
							<div class="form-group col-sm-3">
								<?php echo form_label('Name of Insurance Company:', 'exinfo_other_insurance_name', array("class" => 'col-sm-12')); ?>
								<?php echo form_input("exinfo[other_insurance_name]", isset($eclaim["exinfo_other_insurance_name"]) ? $eclaim["exinfo_other_insurance_name"] : '', array("class" => "form-control", 'placeholder' => 'Name of Insurance Company')); ?>
							</div>
							<div class="form-group col-sm-3">
								<?php echo form_label('Policy #:', 'exinfo_other_insurance_policy', array("class" => 'col-sm-12')); ?>
								<?php echo form_input("exinfo[other_insurance_policy]", isset($eclaim["exinfo_other_insurance_policy"]) ? $eclaim["exinfo_other_insurance_policy"] : '', array("class" => "form-control", 'placeholder' => 'Policy #')); ?>
							</div>
							<div class="form-group col-sm-3">
								<?php echo form_label('Member ID:', 'exinfo_other_insurance_number', array("class" => 'col-sm-12')); ?>
								<?php echo form_input("exinfo[other_insurance_number]", isset($eclaim["exinfo_other_insurance_number"]) ? $eclaim["exinfo_other_insurance_number"] : '', array("class" => "form-control", 'placeholder' => 'Member ID')); ?>
							</div>
							<div class="form-group col-sm-3">
							...
							<div class="col-sm-12">
								Do you have insurance coverage through your spouse? <input type="checkbox" name="exinfo[spouse_insurance]" value="1" <?php if (! empty($eclaim["exinfo_spouse_insurance"])) { echo "checked"; } ?>> Yes. If 'yes', please provide the following information:_
							</div>
							<div class="form-group col-sm-3">
								<?php echo form_label('Name of Insurance Company:', 'exinfo_spouse_insurance_name', array("class" => 'col-sm-12')); ?>
								<?php echo form_input("exinfo[spouse_insurance_name]", isset($eclaim["exinfo_spouse_insurance_name"]) ? $eclaim["exinfo_spouse_insurance_name"] : '', array("class" => "form-control", 'placeholder' => 'Name of Insurance Company')); ?>
							</div>
							<div class="form-group col-sm-3">
								<?php echo form_label('Policy #:', 'exinfo_spouse_insurance_policy', array("class" => 'col-sm-12')); ?>
								<?php echo form_input("exinfo[spouse_insurance_policy]", isset($eclaim["exinfo_spouse_insurance_policy"]) ? $eclaim["exinfo_spouse_insurance_policy"] : '', array("class" => "form-control", 'placeholder' => 'Policy #')); ?>
							</div>
							<div class="form-group col-sm-3">
								<?php echo form_label('Member ID:', 'exinfo_spouse_insurance_number', array("class" => 'col-sm-12')); ?>
								<?php echo form_input("exinfo[spouse_insurance_number]", isset($eclaim["exinfo_spouse_insurance_number"]) ? $eclaim["exinfo_spouse_insurance_number"] : '', array("class" => "form-control", 'placeholder' => 'Member ID')); ?>
							</div>
							<div class="form-group col-sm-3">
								<?php echo form_label('Telephone:', 'exinfo_spouse_insurance_phone', array("class" => 'col-sm-12')); ?>
								<?php echo form_input("exinfo[spouse_insurance_phone]", isset($eclaim["exinfo_spouse_insurance_phone"]) ? $eclaim["exinfo_spouse_insurance_phone"] : '', array("class" => "form-control", 'placeholder' => 'Telephone')); ?>
							</div>
							<div class="form-group col-sm-3">
								<?php echo form_label('Spouse\’s Name:', 'exinfo_spouse_name', array("class" => 'col-sm-12')); ?>
								<?php echo form_input("exinfo[spouse_name]", isset($eclaim["exinfo_spouse_name"]) ? $eclaim["exinfo_spouse_name"] : '', array("class" => "form-control", 'placeholder' => 'Spouse\’s Name')); ?>
							</div>
							<div class="form-group col-sm-3">
								<?php echo form_label('Spouse\’s Date of Birth:', 'exinfo_spouse_dob', array("class" => 'col-sm-12')); ?>
								<div class="input-group date">
									<?php echo form_input("exinfo[spouse_dob]", isset($eclaim["exinfo_spouse_dob"]) ? $eclaim["exinfo_spouse_dob"] : '', array("class" => "form-control datepicker", 'placeholder' => 'Spouse\’s Date of Birth')); ?>
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
								</div>
							</div>
							<div class="clearfix"></div>
							...
							<div class="form-group col-sm-6">
								...
								<?php echo form_input("exinfo[group_insurance_company]", isset($eclaim["exinfo_group_insurance_company"]) ? $eclaim["exinfo_group_insurance_company"] :'', array("class" => "form-control", 'placeholder' => 'Name and Address of Insurance Company')); ?>
							</div>
							<div class="form-group col-sm-3">
						...
						<div class="row" style="display: none">
							<div class="form-group col-sm-3">
								...
								<select name="exinfo[loss_type]" class="form-control">
									...
									<option value="Lost" <?php if ('Lost' == $eclaim["exinfo_loss_type"]) { echo "selected"; } ?>>Lost</option>
									<option value="Theft" <?php if ('Theft' == $eclaim["exinfo_loss_type"]) { echo "selected"; } ?>>Theft</option>
									<option value="Damage" <?php if ('Damage' == $eclaim["exinfo_loss_type"]) { echo "selected"; } ?>>Damage</option>
									<option value="Delay" <?php if ('Delay' == $eclaim["exinfo_loss_type"]) { echo "selected"; } ?>>Delay</option>
								</select>
							</div>
							<div class="form-group col-sm-9">
								<?php echo form_label('Describe how and where the loss occured:', 'exinfo_loss_describe', array("class" => 'col-sm-12')); ?>
								<?php echo form_input("exinfo[loss_describe]", isset($eclaim["exinfo_loss_describe"]) ? $eclaim["exinfo_loss_describe"] : '', array("class" => "form-control", 'placeholder' => 'Describe how and where the loss occured')); ?>
							</div>
							<div class="form-group col-sm-3">
								<?php echo form_label('Date loss occured:', 'exinfo_loss_date', array("class" => 'col-sm-12')); ?>
								<div class="input-group date">
									<?php echo form_input("exinfo[loss_date]", isset($eclaim["exinfo_loss_date"]) ? $eclaim["exinfo_loss_date"] : '', array("class" => "form-control datepicker", 'placeholder' => 'Date loss occured')); ?>
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
								</div>
							</div>
							<div class="form-group col-sm-3">
								...
								<select name="exinfo[loss_report_to]" class="form-control">
									...
									<option value="Airline" <?php if ('Airline' == $eclaim["exinfo_loss_report_to"]) { echo "selected"; } ?>>Airline</option>
									<option value="Cruise line" <?php if ('Cruise line' == $eclaim["exinfo_loss_report_to"]) { echo "selected"; } ?>>Cruise line</option>
									<option value="Bus line" <?php if ('Bus line' == $eclaim["exinfo_loss_report_to"]) { echo "selected"; } ?>>Bus line</option>
									<option value="Tour Guide" <?php if ('Tour Guide' == $eclaim["exinfo_loss_report_to"]) { echo "selected"; } ?>>Tour Guide</option>
									<option value="Hotel" <?php if ('Hotel' == $eclaim["exinfo_loss_report_to"]) { echo "selected"; } ?>>Hotel</option>
									<option value="Police" <?php if ('Police' == $eclaim["exinfo_loss_report_to"]) { echo "selected"; } ?>>Police</option>
									<option value="Other" <?php if ('Other' == $eclaim["exinfo_loss_report_to"]) { echo "selected"; } ?>>Other</option>
								</select>
							</div>
							<div class="form-group col-sm-3">
								<?php echo form_label('If seleced Other please specify:', 'exinfo_loss_report_other', array("class" => 'col-sm-12')); ?>
								<?php echo form_input("exinfo[loss_report_other]", isset($eclaim["exinfo_loss_report_other"]) ? $eclaim["exinfo_loss_report_other"] : '', array("class" => "form-control", 'placeholder' => 'Other specify')); ?>
							</div>
						</div>

<div>
    <h3 style="text-align:center; width:100%">Eclaim - ID#<?php echo $eclaim['id']; ?></h3>
</div>
...
<br />
<br />
<h4>Other Insurance Coverage</h4>
<hr />
...
<div><b>Date: </b><?php echo $eclaim["medication_date_1"]; ?> &nbsp; &nbsp; <b>Medication: </b><?php echo $eclaim["medication_1"]; ?></div>
<div><b>Date: </b><?php echo $eclaim["medication_date_2"]; ?> &nbsp; &nbsp; <b>Medication: </b><?php echo $eclaim["medication_2"]; ?></div>
<div><b>Date: </b><?php echo $eclaim["medication_date_3"]; ?> &nbsp; &nbsp; <b>Medication: </b><?php echo $eclaim["medication_3"]; ?></div>
<br />
<br />

...
<?php if (($policy['product_short'] != "TOP") && ($policy['product_short'] != "TOPN")) { ?>
...
$(document).ready(function() {
  ...
  $('#doc_upload_form').on('hidden.bs.modal', function () {
   ...
   .on("change","input[type=file]", function(){
      ...
      if($.inArray(ext, ['gif','jpg','png','jpeg','bmp','pdf','csv','wav','msg','doc','docx','xls','xlsx']) == -1) {
          alert('invalid extension! Please attach .gif .jpg .png .jpeg .bmp .pdf .csv .wav .msg .doc .docx .xls and .xlsx file.');
          $(this).val('');
          return false;
      }
   ...
   .on("click",".multiupload", function(){
      ...
      // add new file here
      $(".modal-body .files").append('<div class="col-sm-9" style="display:none"><input style="display:none" type="file" name="files[]" id="file'+(count+1)+'" accept="pdf" /><span class="file-label"></span> <i class="fa fa-trash row-link remove_file" id="'+(count+1)+'"></i></div>');

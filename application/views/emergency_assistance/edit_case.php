...
$(document).ready(function() {
   ...
   .on("click", ".select-doc", function(){                                              
      ...
      .replace("'{claimant_name}'", insured_name.replace('<', '&lt;').replace('>', '&gt;'))
      .replace("{claimant_name}", insured_name)
      .replace("'{insured_address}'", insured_address.replace('<', '&lt;').replace('>', '&gt;'))
      ...
      .replace("'{coverage_period}'", ('<?php echo $policy['effective_date'] . " to " . $policy['expiry_date']; ?>').replace('<', '&lt;').replace('>', '&gt;'))
      .replace("{coverage_period}", '<?php echo $policy['effective_date'] . " to " . $policy['expiry_date']; ?>')
      .replace("'{policy_full_name}'", ('<?php echo $product_full_name?>').replace('<', '&lt;').replace('>', '&gt;'))

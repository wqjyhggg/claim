		...
		if ($this->ion_auth->logged_in()) {
			...
			if (!empty($post['id']) && ($post['id'] == $id)) {
				...
				if ($ec) {
					...
					$body  .= "This is an auto-generated email, please do not reply directly. We will reach out to you if your cooperation is needed. Should you have any questions, please contact us by phone at 905-707-3335 or email at claim@otcww.com.\n\n"; 

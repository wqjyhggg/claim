          ...
          if (!empty($this->data['records'])) {
            foreach ($this->data['records'] as $value) {
              ...
              fputcsv($fp, array(
                ...
                empty($value['up_insuer'])?$value['product_short']:"",
                empty($value['up_insuer'])?$value['insured_first_name']:"",
                empty($value['up_insuer'])?$value['insured_last_name']:"",
                empty($value['up_insuer'])?$value['policy_no']:"",
                number_format($value['sum_insured'], 2),
                empty($value['up_insuer'])?$value['effective_date']:"",
                empty($value['up_insuer'])?$value['province']:"",
                empty($value['up_insuer'])?$value['claim_no']:"",
                empty($value['up_insuer'])?$value['package']:"",
                empty($value['up_insuer'])?$value['date_symptoms']:"",
                empty($value['up_insuer'])?$value['status2']:"",
                empty($value['up_insuer'])?$value['status']:"",
                substr($value['created'], 0, 10),
                substr($value['last_update'], 0, 10),
                empty($value['up_insuer'])?$value['opendays']:"",
                empty($value['up_insuer'])?$value['denied_reason']:"",
                empty($value['up_insuer'])?$value['notes']:"",

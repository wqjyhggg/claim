...
class Recoveries extends CI_Controller {
	...
	public function index() {
		if (!$this->ion_auth->logged_in()) {
			...
			$this->data['records'] = $this->expenses_model->get_report($para, "e.recovery_amt");
			
			$this->data['export_url'] = site_url('report/recoveries/export');
			...
			$this->template->write_view('content', 'report/recoveries', $this->data);
	...
	public function export() {
		if (!$this->ion_auth->logged_in()) {
			...
			$records = $this->expenses_model->get_report($para, "e.recovery_amt");

...
INSERT INTO `reasons` (id, name, isfrench) VALUES (1, 'Documentation’s fee is not covered by this policy',0);
INSERT INTO `reasons` (id, name, isfrench) VALUES (2, 'Les frais de documentation ne sont pas couverts par cette police',1);
INSERT INTO `reasons` (id, name, isfrench) VALUES (3, 'Maximum of 30 days’ supply per prescription',0);
INSERT INTO `reasons` (id, name, isfrench) VALUES (4, 'Maximum de 30 jours d’approvisionnement par ordonnance',1);
INSERT INTO `reasons` (id, name, isfrench) VALUES (5, 'No official invoice/receipt provided',0);
INSERT INTO `reasons` (id, name, isfrench) VALUES (6, 'Aucune facture ni aucun reçu officiel fourni',1);
INSERT INTO `reasons` (id, name, isfrench) VALUES (7, 'No original document provided',0);
INSERT INTO `reasons` (id, name, isfrench) VALUES (8, 'Aucun document original fourni',1);
INSERT INTO `reasons` (id, name, isfrench) VALUES (9, 'Not a benefit of this policy',0);
INSERT INTO `reasons` (id, name, isfrench) VALUES (10, 'Ce service n’est pas couvert par cette police',1);
INSERT INTO `reasons` (id, name, isfrench) VALUES (11, 'Not considered an emergency',0);
INSERT INTO `reasons` (id, name, isfrench) VALUES (12, 'Non considéré comme une urgence',1);
INSERT INTO `reasons` (id, name, isfrench) VALUES (13, 'Ongoing care is not covered by this policy',0);
INSERT INTO `reasons` (id, name, isfrench) VALUES (14, 'Les soins continus ne sont pas couverts par cette police',1);
INSERT INTO `reasons` (id, name, isfrench) VALUES (15, 'Other',0);
INSERT INTO `reasons` (id, name, isfrench) VALUES (16, 'Autre',1);
INSERT INTO `reasons` (id, name, isfrench) VALUES (17, 'Symptoms did not appear within policy coverage dates',0);
INSERT INTO `reasons` (id, name, isfrench) VALUES (18, 'Les symptômes ne sont pas apparus pendant la période de couverture de la police',1);
INSERT INTO `reasons` (id, name, isfrench) VALUES (19, 'This dental procedure is not covered by this policy',0);
INSERT INTO `reasons` (id, name, isfrench) VALUES (20, 'Cette intervention dentaire n’est pas couverte par cette police',1);
INSERT INTO `reasons` (id, name, isfrench) VALUES (21, 'Treatment not sought within policy coverage dates',0);
INSERT INTO `reasons` (id, name, isfrench) VALUES (22, 'Le traitement n’a pas été demandé pendant la période de couverture de la police',1);
INSERT INTO `reasons` (id, name, isfrench) VALUES (23, 'Unstable pre-existing condition',0);
INSERT INTO `reasons` (id, name, isfrench) VALUES (24, 'Affection préexistante instable',1);

...
abstract class BlockTag extends Tag
{
	...
	public function open($attr, &$ahtml, &$ihtml)
	{
		...
		if ($tag === 'LI') {
			...
			// Listitem-type
			$this->mpdf->_setListMarker(isset($currblk['list_style_type'])?$currblk['list_style_type']:'', isset($currblk['list_style_image'])?$currblk['list_style_image']:'', isset($currblk['list_style_position'])?$currblk['list_style_position']:'');
		}
